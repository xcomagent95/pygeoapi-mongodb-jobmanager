...
class MongoDBManager(BaseManager):
    ...
    def _connect(self):
        try:
            ...
            self.destroy()
            LOGGER.error("JOBMANAGER - connect error", exc_info=(traceback))
            return False
    ...
    def destroy(self):
        try:
            ...
            self.destroy()
            LOGGER.error("JOBMANAGER - destroy error", exc_info=(traceback))
            return False
    ...
    def get_jobs(self, status=None):
        try:
            ...
            LOGGER.error("JOBMANAGER - get_jobs error", exc_info=(traceback))
            return False
    ...
    def add_job(self, job_metadata):
        try:
            ...
            LOGGER.error("JOBMANAGER - add_job error", exc_info=(traceback))
            return False
